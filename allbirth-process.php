...
<?php
  ...
  if ($user->isLoggedIn()) {
    ...
    $id = $_GET['id'];
    $sql = DB::getInstance()->query("SELECT * FROM birth where b_id ='$id'");
    if ($sql->count()) {
    ?>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="col-md-12 text-center">
            ...
            <a href="birth/<?php echo $sql->first()->file ?>" target="_blank">
            ...
            <div class="form jumbotron col-md-6" style="margin-top:10%; box-shadow:0px 0px 7px 1px #000; padding:30px;">
                ...
                if(Input::exists()){
                    ...
                    $Update = DB::getInstance()->query("UPDATE birth SET
                        status = '$status', 
                    ...
                    if ($Update) {
                        ...
                        <script type="text/javascript">
                            setTimeout(function(){
                            window.location.replace("allbirth-certs.php?user=<?php echo $surname; ?>");
                                       }, 100);
                        </script>
                        <?php
                     }else{
