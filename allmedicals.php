...
?> 
    ...
    <div class="col-md-12">
        ...
        <?php 
      $sql = DB::getInstance()->query("SELECT * FROM medicals");
      ...
      if ($sql->count($sql)) 
      {
       ...
       <tr>
            ...
            <td>
            <a href="allmedicals-process.php?id=<?php echo $sql->m_id; ?>"><button class="btn btn-primary" style="padding:5px;">VIEW</button></a>
            </td>
