...
<?php
  ...
  if ($user->isLoggedIn()) {
    ...
    $id = $_GET['id'];
    $sql = DB::getInstance()->query("SELECT * FROM oath where oa_id ='$id'");
    if ($sql->count()) {
    ?>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="col-md-12 text-center">
            ...
            <a href="oath/<?php echo $sql->first()->file ?>" target="_blank">
                ...
                if(Input::exists()){
                    ...
                    if ($Update) {
                        ...
                        <script type="text/javascript">
                            setTimeout(function(){
                            window.location.replace("alloaths.php?user=<?php echo $surname; ?>");
                                       }, 100);
                        </script>
                        <?php
                     }else{
