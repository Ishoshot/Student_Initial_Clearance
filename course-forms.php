...
?> 
    ...
    <div class="col-md-12">
        ...
        <?php 
      $sql = DB::getInstance()->query("SELECT * FROM course_form");
      ...
      if ($sql->count($sql)) 
      {
       ...
       <tr>
            ...
            <td>
            <a href="courseform-process.php?id=<?php echo $sql->c_id; ?>"><button class="btn btn-primary" style="padding:5px;">VIEW</button></a>
            </td>
