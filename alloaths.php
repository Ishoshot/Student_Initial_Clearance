...
?> 
    ...
    <div class="col-md-12">
        ...
        <?php 
      $sql = DB::getInstance()->query("SELECT * FROM oath");
      ...
      if ($sql->count($sql)) 
      {
       ...
       <tr>
            ...
            <td>
            <a href="alloathsprocess.php?id=<?php echo $sql->oa_id; ?>"><button class="btn btn-primary" style="padding:5px;">VIEW</button></a>
            </td>
