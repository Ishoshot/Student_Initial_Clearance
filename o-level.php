...
<?php
    $query = DB::getInstance()->get('o_level',
                    array(
                        'matric_no', '=', $matric_no
                       ));
    if ($query->count())
        ...
        if ($app == 'Not Approved')
            {
                ...
                <div class='alert  alert-danger alert-dismissible fade show' role='alert'>
                    Your Uploaded O'level Result was not Approved due to the Clarity 
                    <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
                        <span aria-hidden='true'>&times;</span>
                    </button>
                </div>
                ";?>
                    ...
                    <?php require 'upd-levelprocess.php'; 
            ...
            else if ($app == "Approved")
            {
               ?>
                ...
                <strong class="card-title">O'LEVEL RESULT APPROVED ! <span class="badge badge-success float-right mt-1">SUCCESS</span></strong>
                </div>
                <div class="card-body text-center">
                <p class="card-text">Congratulations, Your O'level Result has Successfully been Approved. </p>
                </div>
                </div>
                </div>
                <?php
            ...
            ?>
                ...
                <div class="card">
                <div class="card-header">
                <strong class="card-title">O'LEVEL RESULT ! <span class="badge badge-success float-right mt-1">SUCCESS</span></strong>
                </div>
                <div class="card-body text-center">
                <p class="card-text"> Your O'level Result is pending and will be treated shortly. </p>
                </div>
                </div>
                </div>
                <?php
