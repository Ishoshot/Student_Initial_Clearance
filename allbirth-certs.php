...
?> 
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Birth Certificates</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <div class="col-md-12">
        ...
        <?php 
      $sql = DB::getInstance()->query("SELECT * FROM birth");
      ...
      if ($sql->count($sql)) 
      {
       ...
       <tr>
            ...
            <td>
            <a href="allbirth-process.php?id=<?php echo $sql->b_id; ?>"><button class="btn btn-primary" style="padding:5px;">VIEW</button></a>
            </td>
