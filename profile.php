...
<div class="card mb-3">
    ...
    <div class="row mt-4">
        <div class="col-auto">
            <?php echo "<img src='profile/".$photo."' alt='Profile Picture' height='300' width='300' style='border-radius:50%; align:center;'>"; ?>
        </div>
    </div>
  ...
  <div class="card-body">
    ...
    <div class="row mt-4">
        <div class="col text-center">
            ...
            <?php echo $surname .' '; echo $firstname.' '; echo $othername; ?>
            </h3>
        </div>
    </div>
