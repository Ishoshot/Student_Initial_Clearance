...
<?php
            $query = DB::getInstance()->get('receipts',
                    array(
                        'matric_no', '=', $matric_no
                       ));
    if ($query->count())
        ...
        if ($app == 'Not Approved')
            {
                ...
                <div class='alert  alert-danger alert-dismissible fade show' role='alert'>
                    Your Uploaded Receipts were not Approved due to the Clarity 
                    <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
                        <span aria-hidden='true'>&times;</span>
                    </button>
                </div>
                ";?>
                    ...
                    <?php require 'updreprocess.php'; 
                    echo "<form action='' method='POST' enctype='multipart/form-data'>
                        <div class='form-group mt-4'>
                        <label><b>SCHOOL FEE RECEIPT: </b></label>
                        <input type='file' name='school' class='form-control' style='padding:3px;' accept='.docx, .pdf' required>
                        </div>
                        <div class='form-group mt-4'>
                        <label><b>SUNDRY FEE RECEIPT: </b></label>
                        <input type='file' name='sundry' class='form-control' style='padding:3px;' accept='.docx, .pdf' required>
                        </div>
                        <div class='form-group mt-4'>
                        <label><b>DEPARTMENTAL FEE RECEIPT: </b></label>
                        <input type='file' name='dp_fee' class='form-control' style='padding:3px;' accept='.docx, .pdf' required>
                        </div>
            ...
            else if ($app == "Approved")
            {
                ...
                <strong class="card-title">RECEIPTS APPROVED ! <span class="badge badge-success float-right mt-1">SUCCESS</span></strong>
                </div>
                <div class="card-body text-center">
                <p class="card-text">Congratulations, Your Receipts (School fee), (Sundry fee) and (Departmental fee) has Successfully been Approved. </p>
                </div>
                </div>
                </div>
                <?php
            ...
            else
            {
                ...
                <div class="card">
                <div class="card-header">
                <strong class="card-title">RECEIPTS ! <span class="badge badge-success float-right mt-1">SUCCESS</span></strong>
                </div>
                <div class="card-body text-center">
                <p class="card-text"> Your Receipts (School fee), (Sundry fee) and (Departmental fee) is pending and will be treated shortly. </p>
                </div>
                </div>
                </div>
                <?php
