...
<head>
    ...
    <title>CLEARNCE: WELCOME - ADMIN</title>
...
?> 
    ...
    <aside id="left-panel" class="left-panel" style="background-color:#046b61;">
        <nav class="navbar navbar-expand-sm navbar-default" style="background-color:#046b61;">

            <div class="navbar-header" style="background-color:#046b61;">
...
<div class="col-md-12 text-center mb-2 mt-2">
      ...
      <div class="card col-md-4 mt-5" style="padding:0px !important;">
        <div class="card-body bg-flat-color-1 p-5">
          <div class="div-square">
            <a href="allreceipts.php?user=<?php echo $surname; ?>">
            <i class="fa fa-file-text fa-5x text-white"></i>
            <h4 class="text-white">RECEIPTS</h4>
            </a>
            <div class="progress progress-xs mt-3 mb-0 bg-flat-color-0" style="width: 40%; height: 5px;"></div>
            </div>
          </div>
      </div> 

      <div class="card col-md-4 mt-5" style="padding:0px !important;">
        <div class="card-body bg-flat-color-3 p-5">
          <div class="div-square">
            <a href="admission-letters.php?user=<?php echo $surname; ?>">
            <i class="fa fa-envelope fa-5x text-white"></i>
            <h4 class="text-white">ADMISSION LETTERS</h4>
            </a>
            <div class="progress progress-xs mt-3 mb-0 bg-flat-color-0" style="width: 40%; height: 5px;"></div>
            </div>
          </div>
      ...
      <div class="card col-md-4 mt-5" style="padding:0px !important;">
        <div class="card-body bg-flat-color-2 p-5">
          <div class="div-square">
            <a href="course-forms.php?user=<?php echo $surname; ?>">
            <i class="fa fa-print fa-5x text-white"></i>
            <h4 class="text-white">COURSE FORMS</h4>
            </a>
            <div class="progress progress-xs mt-3 mb-0 bg-flat-color-0" style="width: 40%; height: 5px;"></div>
            </div>
          </div>
...
<div class="col-md-12 text-center mt-2 mb-2">
      ...
      <div class="card col-md-4 mt-5" style="padding:0px !important;">
        <div class="card-body bg-flat-color-4 p-5">
          <div class="div-square">
            <a href="allo-levels.php?user=<?php echo $surname; ?>">
            <i class="fa fa-certificate fa-5x text-white"></i>
            <h4 class="text-white">O'LEVEL RESULTS</h4>
            </a>
            <div class="progress progress-xs mt-3 mb-0 bg-flat-color-0" style="width: 40%; height: 5px;"></div>
            </div>
          </div>
      ...
      <div class="card col-md-4 mt-5" style="padding:0px !important;">
        <div class="card-body bg-flat-color-5 p-5">
          <div class="div-square">
            <a href="allbirth-certs.php?user=<?php echo $surname; ?>">
            <i class="fa fa-info fa-5x text-white"></i>
            <h4 class="text-white">BIRTH CERTS.</h4>
            </a>
            <div class="progress progress-xs mt-3 mb-0 bg-flat-color-0" style="width: 40%; height: 5px;"></div>
            </div>
          </div>
      ...
      <div class="card col-md-4 mt-5" style="padding:0px !important;">
        <div class="card-body bg-flat-color-3 p-5">
          <div class="div-square">
            <a href="allmedicals.php?user=<?php echo $surname; ?>">
            <i class="fa fa-plus-circle fa-5x text-white"></i>
            <h4 class="text-white">MEDICAL FORMS</h4>
            </a>
            <div class="progress progress-xs mt-3 mb-0 bg-flat-color-0" style="width: 40%; height: 5px;"></div>
            </div>
          </div>
...
<div class="col-md-12 text-center mt-2 mb-2">
      ...
      <div class="card col-md-4 mt-5" style="padding:0px !important;">
        <div class="card-body bg-flat-color-1 p-5">
          <div class="div-square">
            <a href="alloaths.php?user=<?php echo $surname; ?>">
            <i class="fa fa-file fa-5x text-white"></i>
            <h4 class="text-white">OATH FORMS</h4>
            </a>
            <div class="progress progress-xs mt-3 mb-0 bg-flat-color-0" style="width: 40%; height: 5px;"></div>
            </div>
          </div>
