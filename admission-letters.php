...
?> 
    ...
    <div class="col-md-12">
        ...
        <?php 
      $sql = DB::getInstance()->query("SELECT * FROM admission_letter");
      ...
      if ($sql->count($sql)) 
      {
       ...
       <tr>
            ...
            <td>
            <a href="adminletter-process.php?id=<?php echo $sql->al_id; ?>"><button class="btn btn-primary" style="padding:5px;">VIEW</button></a>
            </td>
