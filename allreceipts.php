...
?> 
    ...
    <div class="col-md-12">
        ...
        <?php 
      $sql = DB::getInstance()->query("SELECT * FROM receipts");
      ...
      if ($sql->count($sql)) 
      {
       ...
       <tr>
            ...
            <td>
            <a href="allreceiptsprocess.php?id=<?php echo $sql->r_id; ?>"><button class="btn btn-primary" style="padding:5px;">VIEW</button></a>
            </td>
