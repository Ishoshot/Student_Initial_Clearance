...
?> 
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">O'Level Results</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <div class="col-md-12">
        ...
        <?php 
      $sql = DB::getInstance()->query("SELECT * FROM o_level");
      ...
      if ($sql->count($sql)) 
      {
       ...
       <tr>
            ...
            <td>
            <a href="allo-levelsprocess.php?id=<?php echo $sql->ol_id; ?>"><button class="btn btn-primary" style="padding:5px;">VIEW</button></a>
            </td>
          ...
          <?php
            ...
            ?>
                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <p>NO STUDENT HAS UPLOADED IN RECENT TIME !!!</p>
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
