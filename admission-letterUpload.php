...
?> 
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            ...
            <?php
            $query = DB::getInstance()->get('admission_letter',
                    array(
                        'matric_no', '=', $matric_no
                       ));
    if ($query->count())
        ...
        if ($app == 'Not Approved')
            {
                ...
                <div class='alert  alert-danger alert-dismissible fade show' role='alert'>
                    Your Uploaded Admission Letter was not Approved due to the Clarity 
                    <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
                        <span aria-hidden='true'>&times;</span>
                    </button>
                </div>
            ...
            else if ($app == "Approved")
            {
                ...
                <strong class="card-title">ADMISSION LETTER APPROVED ! <span class="badge badge-success float-right mt-1">SUCCESS</span></strong>
                </div>
                <div class="card-body text-center">
                <p class="card-text">Congratulations, Your Admission Letter has Successfully been Approved. </p>
                </div>
                </div>
                </div>
                <?php
            ...
            else
            {
               ?>
                ...
                <div class="card">
                <div class="card-header">
                <strong class="card-title">ADMISSION LETTER ! <span class="badge badge-success float-right mt-1">SUCCESS</span></strong>
                </div>
                <div class="card-body text-center">
                <p class="card-text"> Your Admission Letter is pending and will be treated shortly.</p>
                </div>
                </div>
                </div>
                <?php
