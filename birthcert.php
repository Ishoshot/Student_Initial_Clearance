...
<?php
            $query = DB::getInstance()->get('birth',
                    array(
                        'matric_no', '=', $matric_no
                       ));
    if ($query->count())
        ...
        if ($app == 'Not Approved')
            {
                ...
                <div class='alert  alert-danger alert-dismissible fade show' role='alert'>
                    Your Uploaded Birth Certificate was not Approved due to the Clarity 
                    <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
                        <span aria-hidden='true'>&times;</span>
                    </button>
                </div>
                ";?>
                    ...
                    <?php require 'updbirthprocess.php'; 
            ...
            else if ($app == "Approved")
            {
                ...
                <strong class="card-title">BIRTH CERTIFICATE APPROVED ! <span class="badge badge-success float-right mt-1">SUCCESS</span></strong>
                </div>
                <div class="card-body text-center">
                <p class="card-text">Congratulations, Your Birth Certificate has Successfully been Approved. </p>
                </div>
                </div>
                </div>
                <?php
            ...
            else
            {
               ?>
                ...
                <div class="card">
                <div class="card-header">
                <strong class="card-title">BIRTH CERTIFICATE ! <span class="badge badge-success float-right mt-1">SUCCESS</span></strong>
                </div>
                <div class="card-body text-center">
                <p class="card-text">Your Birth Certificate is pending and will be treated shortly.
                </p>
                </div>
                </div>
                </div>
