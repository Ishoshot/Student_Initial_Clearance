...
<?php
  ...
  if ($user->isLoggedIn()) {
    ...
    $id = $_GET['id'];
    $sql = DB::getInstance()->query("SELECT * FROM receipts where r_id ='$id'");
    if ($sql->count()) {
    ?>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="col-md-12 text-center">
            <div class="col-md-4">
            <h4> <b> SCHOOL FEE: </b><br/><br/> </h4>
            <p>
            <a href="receipts/<?php echo $sql->first()->school ?>" target="_blank">
                <?php echo $sql->first()->school; ?>
            </a>
            </p>
            </div>

            <div class="col-md-4">
            <h4> <b> SUNDRY FEE: </b><br/><br/> </h4>
            <p>
            <a href="receipts/<?php echo $sql->first()->sundry ?>" target="_blank">
                <?php echo $sql->first()->sundry; ?>
            </a>
            </p>
            </div>

            <div class="col-md-4">
            <h4> <b> DEPARTMENTAL FEE: </b><br/><br/> </h4>
            <p>
            <a href="receipts/<?php echo $sql->first()->dp_fee ?>" target="_blank">
                <?php echo $sql->first()->dp_fee; ?>
            </a>
            </p>
            </div>
                ...
                if(Input::exists()){
                    ...
                    if ($Update) {
                        ...
                        <script type="text/javascript">
                            setTimeout(function(){
                            window.location.replace("allreceipts.php?user=<?php echo $surname; ?>");
                                       }, 100);
                        </script>
                        <?php
                     }else{
